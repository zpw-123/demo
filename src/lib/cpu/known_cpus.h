...
microarch_ID_t known_cpus[] =
    {
        ...
        {.family = 0x06, .model = 0x3D, .microarch = Broadwell},
        {.family = 0x06, .model = 0x47, .microarch = Broadwell},
        {.family = 0x06, .model = 0x4F, .microarch = Broadwell},
        {.family = 0x06, .model = 0x56, .microarch = Broadwell},
#endif
