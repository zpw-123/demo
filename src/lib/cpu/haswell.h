...
/*
pmc_hw_event_t haswell_known_hw_event[] = {    
...
pmc_event_t haswell_known_event[] = {          
    {"ldm_stall_cycles", NULL, 0, 0, haswell_create_pmc_ldm_stall_cycles, haswell_clear_pmc_ldm_stall_cycles, haswell_read_pmc_ldm_stall_cycles},
    {"remote_dram", NULL, 0, 0, haswell_create_pmc_remote_dram, haswell_clear_pmc_remote_dram, haswell_read_pmc_remote_dram},
    {NULL, NULL, 0, 0, NULL, NULL, NULL}          
};  

pmc_events_t haswell_pmc_events = {            
    num_hw_cntrs,                                 
    haswell_known_hw_event,                      
    haswell_known_event                          
};
*/
